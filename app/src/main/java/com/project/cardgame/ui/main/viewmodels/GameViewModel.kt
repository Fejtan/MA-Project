...
import com.project.cardgame.data.model.internal.api.EmptyResource
...
import com.project.cardgame.data.repository.game.LevelRepository
...
class GameViewModel : ViewModel()
{
	...
	private fun saveScoreToRemoteDb(score: Int)
	{
		...
		if (score > UserData.highScore)
		{
			...
			val leadersDTO = LeadersDTO(UserData.nickname, UserData.avatarUrl, score)
			val taskSaveScoreToLeaders = apiRepository.saveLeader(currentUser.uid, leadersDTO)
