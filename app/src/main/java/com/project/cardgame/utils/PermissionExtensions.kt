...
import com.project.cardgame.utils.permisionlisteners.RequestPermissionResultListener
...
fun Fragment.handleOpenGalleryPermissionResult(grantResults: IntArray, view: View?, openGalleryFunc: () -> Unit)
{
	activity?.handlePermissionResultWithSnackbar(
		grantResults, view, R.string.galleryPermDeniedSnackbar,
		R.string.galleryPermDeniedPermSnackbar, openGalleryFunc
	)
}
